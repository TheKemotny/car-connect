...
@Slf4j
public class AddressRestControllerAdvisor {

    @ResponseStatus(HttpStatus.NOT_FOUND)
    @ExceptionHandler(value = WrongAddressIdException.class)
    public ResponseDto handleClientNotFoundException(WrongAddressIdException exception) {
